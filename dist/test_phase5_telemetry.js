...
async function runPhase5Tests() {
    ...
    const logger = new logger_1.TradeLogger("test_data_phase5", 20000);
    ...
    for (let i = 0; i < tickCount; i++) {
        ...
        logger.logSignal(BigInt(i + 1), signalType, 0.35, 120.5, 0.02, 95000.0, 95001.0, 0.45 // 0.45 microsecond overhead
        );
    ...
    const wsServer = new server_1.TelemetryWSServer(8089);
    wsServer.start();
    ...
    const backtester = new engine_1.BacktestEngine({
