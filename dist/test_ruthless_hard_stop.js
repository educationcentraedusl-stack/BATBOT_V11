...
function createMockSharedArrayBuffer() {
    ...
    const setMarketState = (seq, bid, ask, vpin, sweep, aiDir, aiConf) => {
...
async function runRuthlessHardStopTests() {
    ...
    const executionClient = new binance_1.BinanceExecutionClient({ apiKey: "test_key", apiSecret: "test_secret" });
    ...
    hedgeLedger.getShortSlots()[0].stopLossPrice = 1868.70;
