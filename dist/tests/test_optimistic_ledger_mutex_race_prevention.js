...
async function runOptimisticLedgerMutexTestSuite() {
    ...
    const cid1 = clientOrderIdGenerator_1.ClientOrderIdGenerator.generate(symbol, "CORE_LONG", "EN");
    ...
    const cid2 = clientOrderIdGenerator_1.ClientOrderIdGenerator.generate(symbol, "CORE_LONG", "EN");
    ...
    const cid3 = clientOrderIdGenerator_1.ClientOrderIdGenerator.generate(symbol, "CORE_LONG", "EN");
    ...
    const cid4 = clientOrderIdGenerator_1.ClientOrderIdGenerator.generate(symbol, "CORE_LONG", "EN");
    ...
    const shortCid0 = clientOrderIdGenerator_1.ClientOrderIdGenerator.generate(symbol, "SHORT_SLOT_0", "EN");
    ...
    const testCid = clientOrderIdGenerator_1.ClientOrderIdGenerator.generate(symbol, "CORE_LONG", "EN");
    // Simulate mock dispatch: placeOrder should register CID in inFlightClientOrderIds
    client.inFlightClientOrderIds.add(testCid);
    ...
    client.inFlightClientOrderIds.delete(testCid);
    console.log("\n================================================================================");
