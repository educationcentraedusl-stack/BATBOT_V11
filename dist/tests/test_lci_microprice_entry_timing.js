...
async function runLCIMicropriceTimingTestSuite() {
    console.log("================================================================================");
    ...
    client.writeAtomicFloat64Asset(0, sabSchema_1.SAB_SLOTS.AI_DIRECTION, 0.90);
    ...
    client.writeAtomicFloat64Asset(0, sabSchema_1.SAB_SLOTS.AI_DIRECTION, -0.80); // Switch to SELL
    client.setShortCooldownLock(0, 0);
