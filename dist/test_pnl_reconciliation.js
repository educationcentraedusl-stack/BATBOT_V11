...
function setAtomicFloat(bigIntView, slot, val) {
    bitcastFloat[0] = val;
...
async function testPnlReconciliationIntegration() {
    ...
    const logger = new logger_1.TradeLogger("data_test");
    ...
    const ledgerResult1 = positionLedger.processFill("BTCUSDT", "BUY", buyFillPx, buyFillQty, fee1);
    ...
    const ledgerResult2 = positionLedger.processFill("BTCUSDT", "SELL", sellFillPx, sellFillQty, fee2);
