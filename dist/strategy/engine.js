        ...
        try {
            ...
            for (const pos of activePositions) {
                ...
                if (!hasSlTpOrder) {
                    ...
                    console.log(`[ORPHAN_GUARD][DISPATCHED] Dynamic Volatility SL/TP attached to ${this.config.symbol} ${posSide} position: SL=${dynamicSlPercent.toFixed(2)}%, TP=${dynamicTpPercent.toFixed(2)}%`);
                }
                else {
