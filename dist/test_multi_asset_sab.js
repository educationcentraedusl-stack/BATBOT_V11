...
async function runMultiAssetSabTests() {
    console.log("=========================================================================");
    ...
    try {
        ...
        new marketDataClient_1.MarketDataClient(smallSab, envMaxAssets, envSlotsPerAsset);
    ...
    const client = new marketDataClient_1.MarketDataClient(sab, envMaxAssets, envSlotsPerAsset);
    ...
    const scaledClient = new marketDataClient_1.MarketDataClient(scaledSab, scaledMaxAssets, envSlotsPerAsset);
