...
import { getLatestFrameSnapshot, WorkerFrameData } from "../store";

export interface TelemetryRefMap {
  sequenceNumRef?: React.RefObject<HTMLElement | null>;
  tickLatencyRef?: React.RefObject<HTMLElement | null>;
  rttMsRef?: React.RefObject<HTMLElement | null>;
  directionRef?: React.RefObject<HTMLElement | null>;
  directionBadgeRef?: React.RefObject<HTMLElement | null>;
  confidenceRef?: React.RefObject<HTMLElement | null>;
  infLatUsRef?: React.RefObject<HTMLElement | null>;
  gate1Ref?: React.RefObject<HTMLElement | null>;
  gate2Ref?: React.RefObject<HTMLElement | null>;
  gate3Ref?: React.RefObject<HTMLElement | null>;
  gate4Ref?: React.RefObject<HTMLElement | null>;
  realizedPnlRef?: React.RefObject<HTMLElement | null>;
  unrealizedPnlRef?: React.RefObject<HTMLElement | null>;
  winRateRef?: React.RefObject<HTMLElement | null>;
  totalTradesRef?: React.RefObject<HTMLElement | null>;
  obiValRef?: React.RefObject<HTMLElement | null>;
  obiBarGreenRef?: React.RefObject<HTMLElement | null>;
  obiBarRedRef?: React.RefObject<HTMLElement | null>;
  cvdValRef?: React.RefObject<HTMLElement | null>;
  bidPriceRef?: React.RefObject<HTMLElement | null>;
  askPriceRef?: React.RefObject<HTMLElement | null>;
}
 ...
 */
export function useTelemetryRefMutator(refs: TelemetryRefMap): void {
  ...
  useEffect(() => {
    ...
    const mutateLoop = () => {
      ...
      const frame: WorkerFrameData | null = getLatestFrameSnapshot();
