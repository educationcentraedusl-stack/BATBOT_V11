...
async function runSotaAiReversalWhipsawEradicationProof() {
  ...
  const ledger1 = new HedgePositionLedger(symbol);
  ...
  const ledger3 = new HedgePositionLedger(symbol);
  ...
  const ledger4 = new HedgePositionLedger(symbol);
  ...
  const ledger5 = new HedgePositionLedger(symbol);
  ...
  let debouncedTriggers: ReturnType<typeof ledger5.evaluateHedgeDynamicTpSl> = [];
  ...
  const ledger6 = new HedgePositionLedger(symbol);
  ...
  let resetTriggers: ReturnType<typeof ledger6.evaluateHedgeDynamicTpSl> = [];
  for (let i = 0; i < 10; i++) {
  ...
  const ledger7 = new HedgePositionLedger(symbol);
