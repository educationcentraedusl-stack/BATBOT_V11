import { OnlineVarianceRatioClassifier } from "../strategy/regimeClassifier";
...
async function runVRRegimeClassifierTestSuite(): Promise<void> {
  console.log("================================================================================");
  ...
  const classifier = new OnlineVarianceRatioClassifier(5, 60, 0.05);
