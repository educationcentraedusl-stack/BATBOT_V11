 ...
 */
class MockHftExecutionClient extends BinanceExecutionClient {
  public placedOrders: BinanceOrderParams[] = [];
  public cancelledOrderIds: (number | string)[] = [];
  public shouldHangNextOrder: boolean = false;
  public hangPromiseResolver: (() => void) | null = null;
  public nextOrderId: number = 910001;

  constructor() {
    super({ apiKey: "MOCK_KEY", apiSecret: "MOCK_SECRET", useTestnet: true });
  }

  public override async placePositionStopLoss(
    symbol: string,
    side: "BUY" | "SELL",
...
async function runSotaDeadlockRecoveryTestSuite(): Promise<void> {
  console.log("==========================================================================================");
