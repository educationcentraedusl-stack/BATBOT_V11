...
import { PositionLedger, HedgePositionLedger } from "./strategy/positionLedger";
...
async function runAuditAndVerification() {
  ...
  const customEngine = new StrategyEngine(mktClient, riskGuard, client, {}, ledger, hedgeLedger);
